...
public class SecureSocketUtils {
  private static final org.apache.logging.log4j.Logger logger    =
      org.apache.logging.log4j.LogManager.getLogger(SecureSocketUtils.class);
   ...
   */
  public static PrivateKey loadPrivateKeyFromPemFile(final String keyFile)
   ...
   * Loads a private key from the specified location.
   */
  public static PrivateKey loadPrivateKeyFromBinaryFile(final String keyFile)
      throws IOException, InvalidKeySpecException, NoSuchAlgorithmException {
    final PKCS8EncodedKeySpec privateKeySpec =
        new PKCS8EncodedKeySpec(loadBinaryFileAsBytes(keyFile));
    final PrivateKey privateKey = KeyFactory.getInstance(ALGORITHM).generatePrivate(privateKeySpec);
    return privateKey;
  }

  /**
   * Loads an X509 certificate from the given inputstream and closes it.
   */
  public static X509Certificate loadX509Certificate(final InputStream is)
   ...
   */
  public static X509Certificate loadX509Certificate(final String certificateFile)
      throws IOException, CertificateException {
    return loadX509Certificate(
        Files.newInputStream(new File(certificateFile).toPath(), StandardOpenOption.READ));
  }
  ...
  public static TrustManagerFactory getTrustManagerFactory(final String caCertificateFile)
    ...
    // Load CA certificate
    final X509Certificate caCertificate = loadX509Certificate(caCertificateFile);
   ...
   */
  public static KeyManagerFactory getKeyManagerFactory(final String keyStoreFile,
      final String keyStorePassword, final String keyPassword, final KeyStoreTypeEnum keyStoreType)
  ...
  public static KeyStore getKeyStoreInstance(final KeyStoreTypeEnum type, final Provider provider)
  ...
  public static KeyStoreTypeEnum getTypeFromFilename(final String filename) {
    if (filename == null || filename.isEmpty()) {
      ...
      return KeyStoreTypeEnum.PKCS12;
  ...
  public static enum KeyStoreTypeEnum {

    DEFAULT("DEFAULT"), JKS("JKS"), JCEKS("JCEKS"), PKCS12("PKCS12"), BKS("BKS");
